...
<?php include 'topnav.php'; ?>
    ...
    <div data-bs-spy="scroll" data-bs-target="#metrix-scrollspy" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true">
        ...
        <section class="feature-one after-banner">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="page-head-one">
                            <h2 class="page-head-one-title">Revolutionize Your Online<br> App Business Today!</h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-one-card mb-5 mb-lg-0">
                            <div class="feature-one-img-icon">
                                <img src="assets/images/icons/icon-trendy-look.svg" alt="feature-icon" />
                            </div>
                            <h3 class="feature-one-title">Trendy Look</h3>
                            <p class="feature-one-text">We provide marketing to
                                businesses to looking for a partner
                                digital media.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-one-card mb-5 mb-lg-0">
                            <div class="feature-one-img-icon">
                                <img src="assets/images/icons/icon-secured.svg" alt="feature-icon" />
                            </div>
                            <h3 class="feature-one-title">Very Secured</h3>
                            <p class="feature-one-text">We provide marketing to
                                businesses to looking for a partner
                                digital media.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-one-card mb-5 mb-lg-0">
                            <div class="feature-one-img-icon">
                                <img src="assets/images/icons/icon-digital-marketing.svg" alt="feature-icon" />
                            </div>
                            <h3 class="feature-one-title">Digital Marketing</h3>
                            <p class="feature-one-text">We provide marketing to
                                businesses to looking for a partner
                                digital media.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-one-card mb-5 mb-lg-0">
                            <div class="feature-one-img-icon">
                                <img src="assets/images/icons/icon-report-analysis.svg" alt="feature-icon" />
                            </div>
                            <h3 class="feature-one-title">Report Analysis</h3>
                            <p class="feature-one-text">We provide marketing to
                                businesses to looking for a partner
                                digital media.</p>
                        </div>
        ...
        <section class="work-precess-one">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="page-head-one">
